                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8" id="wrap-stato_richiesta">
                            <div class="col-sm-12" id="wrap-indirizzo_carico">
                                <input name="planDate" type="date" class="form-control input-sm" value=""
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8" id="wrap-indirizzo_carico">
                            <input name="note" type="text" class="form-control input-sm" value=""
                                   placeholder="Descrizione Indirizzo Carico">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2" id="wrap-indirizzo_carico">
                            <input name="jsontime" type="time" class="mt-2 form-control input-sm" value=""
                                   placeholder="Descrizione Indirizzo Carico">
                        </div>
